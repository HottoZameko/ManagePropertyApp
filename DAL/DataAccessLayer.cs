...
namespace DAL
{
    ...
    {
        static string ConString = "Data Source= localhost; Initial Catalog = ManagePropertyDB; Integrated Security = true;";
        ...
        public int InsertProvinces(Provinces provinces)
        {
            ...
            dbComm = new SqlCommand("sp_InsertProvinces", dbConn);
            dbComm.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable GetSearchPrice(Price p)
        {
            dbConn.Open();

            dbComm = new SqlCommand("sp_GetSearchPrice", dbConn);
            dbComm.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable GetOverRentals()
        {
            dbConn.Open();

            dbComm = new SqlCommand("sp_RentalsThatAreOver", dbConn);
            dbComm.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable RentalsAndAgents()
        {
            ...
            dbComm = new SqlCommand("sp_GetRentalsAndAgents", dbConn);
            dbComm.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable PropertyAndTypes()
        {
            dbConn.Open();

            dbComm = new SqlCommand("sp_GetPropertiesAndTypes", dbConn);
            dbComm.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable MaxAgent()
        {
            ...
            dbComm = new SqlCommand("sp_GetMaximumAgent", dbConn);
            dbComm.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable CityProvinceSuburb()
        {
            ...
            dbComm = new SqlCommand("sp_CitySuburbProvince", dbConn);
            dbComm.CommandType = CommandType.StoredProcedure;
